...
function annotation_CRF_landmark(strain,data,out_file,node_pot_type,atlasname,varargin)
...
load([data,'.mat']) % load segmentation results 
load(['/Users/hyunjee/Dropbox (GaTech)/Whole-brain codes/CRF_ID 2.0/utils/' atlasname])
%load('C:\Users\hlee895\Desktop\CRF_Cell_ID-master\Run_SyntheticData\data_neuron_relationship')

% specify candidate list    
keep_list = {'AVAL', 'AVAR', 'AVEL', 'AVER', 'RIML', 'RIMR', 'RMDDL', 'RMDDR', 'RMDL', 'RMDR',...
              ...
              'AIAL', 'AIAR','URYDR', 'URYDL','RMEL','RMER','M1', 'RIAL','RIAR'}; % glr1 list (39)
